...
router.get('/',jwtMiddleware,(req,res) => { //This route should be a PUT/PATCH
  controller.updateToken(req.query.id,null).then((result) => { //Set token db to null  
...
router.post('/',checkemail, function(req, res, next) { //Auth user
